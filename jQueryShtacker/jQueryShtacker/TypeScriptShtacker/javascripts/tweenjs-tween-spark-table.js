...
var TweenJSTweenSparkTable = (function () {
    ...
    TweenJSTweenSparkTable.prototype.init = function () {
        ...
        for (var i = 0, l = this.dataProvider.length; i < l; i++) {
            ...
            clonedElement = baseElement.cloneNode(true);
            clonedElement.id = i;
            clonedElement.onclick = function (event) {
    ...
    TweenJSTweenSparkTable.prototype.selectItem = function (selectedElement) {
        ...
        createjs.Tween.get(this.bar, { override: true }).to({ x: 0, y: 0 }, 500).call(function () {
            _this.resetComplete();
        });
        return false;
    };
    ...
    TweenJSTweenSparkTable.prototype.fade = function () {
        ...
        for (var i = 0; i < this.clips.length; i++) {
            ...
            tween.to({ alpha: clip.alpha - 0.4 }, 1000).call(function (cTween) {
                _this.fadeTweenComplete(cTween);
            });
        }
    };
