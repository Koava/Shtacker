...
var soundJSConvultion: SoundJSConvultion;
window.onload = () => {
...
class SoundJSConvultion
{
	// Membes
	private m_Preload:createjs.PreloadJS;
	private m_Instance:createjs.SoundInstance;	// Controllable instance
	...
	public init(): void
	{
		...
		this.m_Preload.onComplete = () => { this.handleLoadComplete(); };
